#!/usr/bin/env python3
"""
Script de Migração CORRIGIDO - Melhorias do Portal de Despesas
Implementa: Casa em Ordem, Despesas Fixas, Cartões de Crédito e Gestão de Usuários
Resolve: Erro "Cannot add a column with non-constant default" E "table users_new already exists"
"""
...
def migrate_database():
    ...
    try:
        ...
        # 4. CRIAR TABELA DE DESPESAS FIXAS
        print("📅 [4/8] Criando sistema de despesas fixas...")
        ...
        # 5. MIGRAR TABELA DE DESPESAS
        print("💰 [5/8] Migrando tabela de despesas...")
        ...
        # 6. CRIAR TABELA DE CATEGORIAS (SE NÃO EXISTIR)
        print("🏷️ [6/8] Verificando tabela de categorias...")
        ...
        for nome, desc, cor, icone in categorias_padrao:
            ...
            if not existe:
                cursor.execute('''
                    INSERT INTO categorias (nome, descricao, cor, icone, ativo, created_at)
...
if __name__ == '__main__':
    print("=" * 50)
    print("   MIGRAÇÃO CORRIGIDA - MELHORIAS DO PORTAL")
    print("=" * 50)
    print()
