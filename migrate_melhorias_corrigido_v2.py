#!/usr/bin/env python3
"""
Script de Migração CORRIGIDO v2 - Melhorias do Portal de Despesas
Implementa: Casa em Ordem, Despesas Fixas, Cartões de Crédito e Gestão de Usuários
Resolve: Erro "table categorias has no column named descricao"
"""
...
def migrate_database():
    ...
    try:
        ...
        # 6. MIGRAR TABELA DE CATEGORIAS
        print("🏷️ [6/8] Migrando tabela de categorias...")
...
if __name__ == '__main__':
    print("=" * 50)
    print("   MIGRAÇÃO CORRIGIDA v2 - MELHORIAS DO PORTAL")
    print("=" * 50)
    print()
